...
var rules = {
  ...
  'isCreditCard': {
    fn: validator.isCreditCard,// TODO: add strict _.isString() check (otherwise throw)
    expectedTypes: ['json', 'ref', 'string'],
    defaultErrorMessage: 'Value was not a valid credit card.',
    ignoreEmptyString: true
  },
  'isEmail': {
    fn: validator.isEmail,// TODO: add strict _.isString() check (otherwise throw)
    expectedTypes: ['json', 'ref', 'string'],
    defaultErrorMessage: 'Value was not a valid email address.',
    ignoreEmptyString: true
  },
  'isHexColor': {
    fn: validator.isHexColor,// TODO: add strict _.isString() check (otherwise throw)
    expectedTypes: ['json', 'ref', 'string'],
    defaultErrorMessage: 'Value was not a valid hex color.',
    ignoreEmptyString: true
  },
  'isIn': {
    fn: validator.isIn,// TODO: replace with lodash
    expectedTypes: ['json', 'ref', 'string', 'number'],
  ...
  'isIP': {
    fn: validator.isIP,// TODO: add strict _.isString() check (otherwise throw)
    expectedTypes: ['json', 'ref', 'string'],
  ...
  'isURL': {
    fn: function(x, opt) {
      // TODO: add strict _.isString() check (otherwise throw)
  ...
  'custom': {
    ...
    checkConfig: function(constraint) {
      ...
      // TODO: add strict AsyncFunction check
      return false;
    }
